...
#            print obs_mc.GetName(),' > ',str(binMin)
        ...
        newFormatInput_lamdg.SetName('bin_content_lam_dg_'+str(i)+'_'+str(int(binMin))+'to'+str(int(binMax))+'GeV')
        newFormatInput_dkdg=newFormatInput.Clone("name2")
        newFormatInput_dkdg.SetName('bin_content_dk_dg_'+str(i)+'_'+str(int(binMin))+'to'+str(int(binMax))+'GeV')
